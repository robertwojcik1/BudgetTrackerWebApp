        ...
        <section>
            <div class="container" style="width: 400px">
                ...
                <form action="income.php" method="post">
                    ...
                    <div class="input-group mb-3">
                        <div><label for="datepicker"><input type="date" name="date" class="form-control" id="datepicker"
                    ...
                    <div class="form-check">
                        <label for="submit"><button type="submit" class="btn btn-success"
                                id="submit">Dodaj</button></label>
                    </div>
                    <div class="form-check">
                        <label for="cancel"><a class="btn btn-secondary" href="main-menu.html" role="button"
